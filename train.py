...
def main():
    ...
    experiment_name = f'{shape_class}_{experiment_type}_{num_points}points__{epochs}epochs__{latent_code_length}latent_code__{class_embedding_length}class_embedding_length__{num_encoding_functions}enc__{number_of_classes}cls'
