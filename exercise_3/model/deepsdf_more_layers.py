...
class DeepSDFDecoder(nn.Module):
    ...
    def __init__(self, latent_size, experiment_type='vanilla', num_encoding_functions=4):
        ...
        self.lin9 = torch.nn.utils.weight_norm(nn.Linear(512, 512))
        self.relu9 = nn.ReLU()
        self.drop9 = nn.Dropout(dropout_prob)

        self.lin10 = torch.nn.utils.weight_norm(nn.Linear(512, 512))
        self.relu10 = nn.ReLU()
        self.drop10 = nn.Dropout(dropout_prob) 
