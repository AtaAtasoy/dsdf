...
def main():
    ...
    val_file = f'/home/atasoy/project/dsdf/exercise_3/data/splits/{shape_class}/val.txt'
    shape_ids = Path(val_file).read_text().splitlines()
    ...
    for shape_id in shape_ids:
        ...
        try:
            ...
            mesh_path = f'/mnt/hdd/atasoy_dataset/ml3d/{shape_class}/{shape_id}/mesh.obj'
